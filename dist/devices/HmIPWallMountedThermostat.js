...
exports.HmIPWallMountedThermostat = void 0;
 ...
 *
 */
class HmIPWallMountedThermostat extends HmIPGenericDevice_1.HmIPGenericDevice {
    service;
    actualTemperature = 0;
    ...
    constructor(platform, accessory) {
        ...
        const temperatureSensorService = this.accessory.getService(this.platform.Service.TemperatureSensor);
        if (temperatureSensorService) {
            this.accessory.removeService(temperatureSensorService);
        }
        const humiditySensorService = this.accessory.getService(this.platform.Service.HumiditySensor);
    ...
    updateDevice(hmIPDevice, groups) {
        ...
        for (const id in hmIPDevice.functionalChannels) {
            ...
            if (channel.functionalChannelType === 'WALL_MOUNTED_THERMOSTAT_PRO_CHANNEL'
                ...
                this.historyService.addEntry({ time: (0, moment_1.default)().unix(), temp: this.actualTemperature, pressure: 0, humidity: this.humidity });
...
exports.HmIPWallMountedThermostat = HmIPWallMountedThermostat;
