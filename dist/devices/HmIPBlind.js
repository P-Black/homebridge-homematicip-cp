...
exports.HmIPBlind = void 0;
const HmIPShutter_1 = require("./HmIPShutter");
/**
 * HomematicIP blind
 *
 ...
 *
 */
class HmIPBlind extends HmIPShutter_1.HmIPShutter {
    ...
    async handleTargetHorizontalTiltAngleSet(value, callback) {
        ...
        const body = {
            ...
            shutterLevel: HmIPShutter_1.HmIPShutter.shutterHomeKitToHmIP(this.shutterLevel),
