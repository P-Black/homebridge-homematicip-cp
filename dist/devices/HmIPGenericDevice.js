...
exports.HmIPGenericDevice = void 0;
/**
 * Generic device
 */
class HmIPGenericDevice {
    platform;
    accessory;
    hidden = false;
    unreach = false;
    ...
    constructor(platform, accessory) {
        ...
        this.accessory.getService(this.platform.Service.AccessoryInformation)
            .setCharacteristic(this.platform.Characteristic.Name, accessory.context.device.label)
...
exports.HmIPGenericDevice = HmIPGenericDevice;
